...
python_lint_paths := "pyvicinity tests/test_python.py tests/test_download_ann_benchmarks.py tests/test_generate_ann_smoke_data.py tests/test_generate_multiscale_data.py tests/test_generate_sample_data.py tests/test_generate_sparse_mips_smoke_data.py tests/test_summarize_ann_results.py tests/test_plot_comparison.py tests/test_plot_pareto.py examples/python scripts/generate_ann_smoke_data.py scripts/generate_sample_data.py scripts/generate_sparse_mips_smoke_data.py scripts/download_ann_benchmarks.py scripts/summarize_ann_results.py"
python_test_paths := "tests/test_python.py tests/test_download_ann_benchmarks.py tests/test_generate_ann_smoke_data.py tests/test_generate_multiscale_data.py tests/test_generate_sample_data.py tests/test_generate_sparse_mips_smoke_data.py tests/test_summarize_ann_results.py tests/test_plot_comparison.py tests/test_plot_pareto.py"
