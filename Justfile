...
python_lint_paths := "pyvicinity tests/test_python.py tests/test_download_ann_benchmarks.py tests/test_generate_ann_smoke_data.py tests/test_generate_multiscale_data.py tests/test_generate_sample_data.py tests/test_generate_sparse_mips_smoke_data.py tests/test_summarize_ann_results.py examples/python scripts/generate_ann_smoke_data.py scripts/generate_sample_data.py scripts/generate_sparse_mips_smoke_data.py scripts/download_ann_benchmarks.py scripts/summarize_ann_results.py"
python_test_paths := "tests/test_python.py tests/test_download_ann_benchmarks.py tests/test_generate_ann_smoke_data.py tests/test_generate_multiscale_data.py tests/test_generate_sample_data.py tests/test_generate_sparse_mips_smoke_data.py tests/test_summarize_ann_results.py"
...
py-test: py-build
    .venv/bin/python -m pytest {{python_test_paths}} -v

# Lint the Python sources with ruff
py-lint:
    .venv/bin/python -m ruff check {{python_lint_paths}}

# Check Python formatting with ruff
py-fmt:
    .venv/bin/python -m ruff format --check {{python_lint_paths}}
...
# Full Python QA: build + lint + format + typecheck + stubtest + test
py-qa: py-build py-lint py-fmt py-typecheck py-stubtest py-test
