...
- A 50K-vector classical sweep with broader tree settings now separates the
  ...
  Treat both as controllable classical baselines and completeness rows, not
  graph competitors.
